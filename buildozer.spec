...
requirements = python3==3.11.5,hostpython3==3.11.5,libxml2,libxslt,kivy,pillow,requests,requests_toolbelt,openssl,beautifulsoup4,lxml==4.9.2,ebooklib,cloudscraper,transliterate,tqdm,typing_extensions
